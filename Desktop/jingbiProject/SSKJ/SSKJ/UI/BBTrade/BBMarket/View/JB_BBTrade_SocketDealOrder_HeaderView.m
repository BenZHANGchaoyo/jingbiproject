...
-(void)addLabels
{
    ...
    for (int i = 0; i < array.count; i++) {
        ...
        UILabel *label = [WLTools allocLabel:title font:systemFont(ScaleW(13)) textColor:kTextDarkBlueColor frame:CGRectMake(ScaleW(15) + i * width, 0, width, self.height) textAlignment:NSTextAlignmentLeft];
