...
{
    if (nil == _titleLabel) {
        _titleLabel = [WLTools allocLabel:SSKJLocalized(@"描述", nil)  font:systemBoldFont(ScaleW(13)) textColor:kMainWihteColor frame:CGRectMake(ScaleW(15), ScaleW(15), ScaleW(200), ScaleW(13)) textAlignment:NSTextAlignmentLeft];
    }
    return _titleLabel;
}
...
-(UIButton *)deleteButton
{
    if (nil == _deleteButton) {
        ...
        [_deleteButton setTitleColor:kMainTextColor forState:UIControlStateNormal];
...
-(UILabel *)addressLabel
{
    if (nil == _addressLabel) {
        _addressLabel = [WLTools allocLabel:@"adbflasdhfkasdnf;" font:systemFont(ScaleW(11)) textColor:kMainTextColor frame:CGRectMake(self.titleLabel.x, self.titleLabel.bottom + ScaleW(15), ScreenWidth - ScaleW(30), ScaleW(11)) textAlignment:NSTextAlignmentLeft];
    }
