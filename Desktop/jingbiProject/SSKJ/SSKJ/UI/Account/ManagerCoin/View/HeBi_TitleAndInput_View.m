...
-(UILabel *)titleLabel
{
    ...
    if (nil == _titleLabel) {
        _titleLabel =[WLTools allocLabel:_title font:systemFont(ScaleW(15)) textColor:[UIColor colorWithHexStringToColor:@"a7abdb"] frame:CGRectMake(_leftGap, ScaleW(20), ScaleW(200), ScaleW(15)) textAlignment:NSTextAlignmentLeft];
    }
    return _titleLabel;
}
