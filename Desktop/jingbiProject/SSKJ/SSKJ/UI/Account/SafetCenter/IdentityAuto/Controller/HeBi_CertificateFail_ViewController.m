...
{
    if (nil == _reasonLabel) {
//        _reasonLabel = [WLTools allocLabel:[NSString stringWithFormat:@"失败原因：%@", [ManagerSocket sharedManager].model.apply_reason] font:systemFont(ScaleW(12)) textColor:TextGrayColor frame:CGRectMake(ScaleW(15), self.tipLabel.bottom + ScaleW(16), ScreenWidth - ScaleW(30), ScaleW(14)) textAlignment:NSTextAlignmentCenter];
