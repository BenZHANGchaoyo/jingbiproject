...
- (HomeCustomButton *)rechargeButton {
    if (!_rechargeButton) {
        ...
        [_rechargeButton setTitleColor:[UIColor colorWithHexStringToColor:@"fefefe"] forState:UIControlStateNormal];
...
- (HomeCustomButton *)carryButton {
    if (!_carryButton) {
        ...
        [_carryButton setTitleColor:[UIColor colorWithHexStringToColor:@"fefefe"] forState:UIControlStateNormal];
    }
    return _carryButton;
}
- (HomeCustomButton *)turnButton {
    if (!_turnButton) {
        ...
        [_turnButton setTitleColor:[UIColor colorWithHexStringToColor:@"fefefe"] forState:UIControlStateNormal];
    }
    return _turnButton;
}
#pragma mark -- Setter Method

-(void)setViewWithModel:(JB_PledgeBorrowModel *)model
{
//    [self.moneyBT setTitle:[WLTools noroundingStringWith:[model.ttl[@"btc"] doubleValue] afterPointNumber:6] forState:UIControlStateNormal];
//    self.cnyLB.text = [NSString stringWithFormat:@"≈$%@",[WLTools noroundingStringWith:[model.ttl[@"usdt"] doubleValue] afterPointNumber:2]];
//
}
