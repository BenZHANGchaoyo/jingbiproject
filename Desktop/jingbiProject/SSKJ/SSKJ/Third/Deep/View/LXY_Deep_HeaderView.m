...
-(UILabel *)buyIndexLabel
{
    if (nil == _buyIndexLabel) {
        _buyIndexLabel = [WLTools allocLabel:@"买盘" font:systemFont(ScaleW(10)) textColor:[UIColor lxy_volumeColor] frame:CGRectMake(ScaleW(15), 0, ScaleW(25), kCell_Height) textAlignment:NSTextAlignmentCenter];
...
-(UILabel *)sellIndexLabel
{
    if (nil == _sellIndexLabel) {
        _sellIndexLabel = [WLTools allocLabel:@"卖盘" font:systemFont(ScaleW(10)) textColor:[UIColor lxy_volumeColor] frame:CGRectMake(ScreenWidth - ScaleW(15) - ScaleW(25), 0, ScaleW(25), kCell_Height) textAlignment:NSTextAlignmentCenter];
    }
...
-(UILabel *)sellAmmountLabel
{
    if (nil == _sellAmmountLabel) {
        _sellAmmountLabel = [WLTools allocLabel:@"成交量(BTC)" font:systemFont(ScaleW(10)) textColor:[UIColor lxy_volumeColor] frame:CGRectMake(self.sellIndexLabel.x - ScaleW(150), 0, ScaleW(150), kCell_Height) textAlignment:NSTextAlignmentRight];
    }
