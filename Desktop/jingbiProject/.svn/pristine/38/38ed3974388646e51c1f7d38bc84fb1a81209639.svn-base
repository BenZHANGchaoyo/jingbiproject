...
-(void)viewConfig
{
    ...
    [self btn:_takePhoto font:15 textColor:kMainTextColor text:@"拍照" image:nil];
    self.takePhoto.backgroundColor = kMainWihteColor;
    ...
    [self btn:_selectLibry font:15 textColor:kMainTextColor text:@"选择相册" image:nil];
    _selectLibry.backgroundColor = kMainWihteColor;
    ...
    [self btn:_cancellBtn font:15 textColor:kMainWihteColor text:@"取消" image:nil];
    _cancellBtn.backgroundColor = kMainWihteColor;
