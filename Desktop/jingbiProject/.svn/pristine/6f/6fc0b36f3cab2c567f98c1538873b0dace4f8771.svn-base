...
-(UIButton *)sliderButton
{
    if (nil == _sliderButton) {
        _sliderButton = [[UIButton alloc]initWithFrame:CGRectMake(self.width - ScaleW(15) - ScaleW(16), Height_StatusBar, ScaleW(16), ScaleW(16))];
...
-(FBDeal_Segment_Control *)segmentControl
{
    if (nil == _segmentControl) {
        _segmentControl = [[FBDeal_Segment_Control alloc]initWithFrame:CGRectMake(0, self.titleLabel.bottom, self.width, ScaleW(40)) titles:@[@"USDT",@"BTC",@"ETH"] normalColor:kMainWihteColor selectedColor:kTextLightBlueColor fontSize:ScaleW(13)];
        WS(weakSelf);
