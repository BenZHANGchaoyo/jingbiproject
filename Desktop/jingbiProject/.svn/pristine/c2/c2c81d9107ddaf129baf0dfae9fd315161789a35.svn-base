...
-(UILabel *)headerLabel{
    if (!_headerLabel) {
        ...
        [_headerLabel label:_headerLabel font:ScaleW(13) textColor:kTextColor5b5e95 text:@"商家自由购买USDT，交易更灵活更便捷"];
...
-(UITextField *)amountTF
{
    if (!_amountTF) {
        ...
        [_amountTF textField:_amountTF textFont:ScaleW(14) placeHolderFont:ScaleW(14) text:nil placeText:@"发布购买数量" textColor:kTextColor5b5e95 placeHolderTextColor:kTextColor5b5e95];
...
-(UITextField *)lowLimitTf
{
    if (!_lowLimitTf) {
        ...
        [_lowLimitTf textField:_lowLimitTf textFont:ScaleW(14) placeHolderFont:ScaleW(14) text:nil placeText:@"最低" textColor:kTextColor5b5e95 placeHolderTextColor:kTextColor5b5e95];
...
-(UITextField *)hightLimitTf
{
    if (!_hightLimitTf) {
        ...
        [_hightLimitTf textField:_hightLimitTf textFont:ScaleW(14) placeHolderFont:ScaleW(14) text:nil placeText:@"最高" textColor:kTextColor5b5e95 placeHolderTextColor:kTextColor5b5e95];
...
-(UITextField *)signlePriceTf
{
    if (!_signlePriceTf) {
        ...
        [_signlePriceTf textField:_signlePriceTf textFont:ScaleW(14) placeHolderFont:ScaleW(14) text:nil placeText:@"请输入购买单价" textColor:kTextColor5b5e95 placeHolderTextColor:kTextColor5b5e95];
...
-(UITextField *)momoTf
{
    if (!_momoTf) {
        ...
        [_momoTf textField:_momoTf textFont:ScaleW(14) placeHolderFont:ScaleW(14) text:nil placeText:@"请输入要备注信息（选填）" textColor:kTextColor5b5e95 placeHolderTextColor:kTextColor5b5e95];
