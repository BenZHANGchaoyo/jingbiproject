...
-(UIButton *)buyButton
{
    if (nil == _buyButton) {
        ...
        [_buyButton setTitleColor:kTextLightWhiteColor forState:UIControlStateNormal];
        [_buyButton setTitleColor:GREEN_HEX_COLOR forState:UIControlStateSelected];
        _buyButton.backgroundColor = kBGGrayColor;
...
-(UIButton *)sellButton
{
    if (nil == _sellButton) {
        ...
        _sellButton.backgroundColor = kBGGrayColor;
        _sellButton.titleLabel.font = systemFont(ScaleW(15));
        [_sellButton setTitleColor:kTextLightWhiteColor forState:UIControlStateNormal];
