...
{
    if (nil == _titleLabel) {
        _titleLabel = [WLTools allocLabel:@"" font:systemFont(ScaleW(13)) textColor:kTextLightWhiteColor frame:CGRectMake(0, 0, self.width, ScaleW(13)) textAlignment:NSTextAlignmentLeft];
    }
    return _titleLabel;
}
...
-(UIView *)backView
{
    if (nil == _backView) {
        ...
        _backView.layer.borderColor = kTextLightWhiteColor.CGColor;
