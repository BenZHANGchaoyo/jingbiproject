...
-(UILabel *)addressTitleLabel
{
    if (nil == _addressTitleLabel) {
        _addressTitleLabel = [WLTools allocLabel:SSKJLocalized(@"充币地址", nil) font:systemThinFont(ScaleW(13.5)) textColor:kMainWihteColor frame:CGRectMake(ScaleW(15), ScaleW(18), ScaleW(70), ScaleW(14)) textAlignment:NSTextAlignmentLeft];
    }
...
-(UILabel *)addressLabel
{
    if (nil == _addressLabel) {
        _addressLabel = [WLTools allocLabel:SSKJLocalized(@"", nil) font:systemThinFont(ScaleW(13.5)) textColor:kLineGrayColor frame:CGRectMake(self.addressTitleLabel.right, ScaleW(22), ScreenWidth - ScaleW(15) - ScaleW(65) - self.addressTitleLabel.right, ScaleW(14)) textAlignment:NSTextAlignmentLeft];
    }
...
-(UILabel *)amountTitleLabel
{
    if (nil == _amountTitleLabel) {
        _amountTitleLabel = [WLTools allocLabel:SSKJLocalized(@"充币数量", nil) font:systemThinFont(ScaleW(13.5)) textColor:kMainWihteColor frame:CGRectMake(ScaleW(15), self.addressTitleLabel.bottom + ScaleW(13.5), ScaleW(70), ScaleW(14)) textAlignment:NSTextAlignmentLeft];
    }
...
{
    if (nil == _amountLabel) {
        _amountLabel = [WLTools allocLabel:SSKJLocalized(@"xxxx", nil) font:systemThinFont(ScaleW(13.5)) textColor:kLineGrayColor frame:CGRectMake(self.amountTitleLabel.right,self.amountTitleLabel.y, ScreenWidth - self.amountTitleLabel.right - ScaleW(15), ScaleW(14)) textAlignment:NSTextAlignmentLeft];
    }
    return _amountLabel;
}
...
-(UILabel *)submitTimeTitleLabel
{
    if (nil == _submitTimeTitleLabel) {
        _submitTimeTitleLabel = [WLTools allocLabel:SSKJLocalized(@"提交时间", nil) font:systemThinFont(ScaleW(13.5)) textColor:kMainWihteColor frame:CGRectMake(ScaleW(15), self.amountTitleLabel.bottom + ScaleW(13.5), ScaleW(70), ScaleW(14)) textAlignment:NSTextAlignmentLeft];
    }
...
-(UILabel *)submitTimeLabel
{
    if (nil == _submitTimeLabel) {
        _submitTimeLabel = [WLTools allocLabel:SSKJLocalized(@"", nil) font:systemThinFont(ScaleW(13.5)) textColor:kLineGrayColor frame:CGRectMake(self.amountTitleLabel.right,self.submitTimeTitleLabel.y, ScreenWidth - self.amountTitleLabel.right - ScaleW(15), ScaleW(14)) textAlignment:NSTextAlignmentLeft];
    }
...
-(UILabel *)checkTimeTitleLabel
{
    if (nil == _checkTimeTitleLabel) {
        _checkTimeTitleLabel = [WLTools allocLabel:SSKJLocalized(@"审核时间", nil) font:systemThinFont(ScaleW(13.5)) textColor:kMainWihteColor frame:CGRectMake(ScaleW(15), self.submitTimeTitleLabel.bottom + ScaleW(13.5), ScaleW(70), ScaleW(14)) textAlignment:NSTextAlignmentLeft];
    }
...
-(UILabel *)checkTimeLabel
{
    if (nil == _checkTimeLabel) {
        _checkTimeLabel = [WLTools allocLabel:SSKJLocalized(@"", nil) font:systemThinFont(ScaleW(13.5)) textColor:kLineGrayColor frame:CGRectMake(self.amountTitleLabel.right,self.checkTimeTitleLabel.y, ScreenWidth  - self.amountTitleLabel.right- ScaleW(15), ScaleW(14)) textAlignment:NSTextAlignmentLeft];
    }
...
-(UIButton *)cancleButton
{
    if (nil == _cancleButton) {
        ...
        _cancleButton.layer.borderColor = kMainTextColor.CGColor;
...
{
    if (nil == _statusLabel) {
        _statusLabel = [WLTools allocLabel:@"已到账" font:systemThinFont(ScaleW(13)) textColor:kMainTextColor frame:CGRectMake(ScreenWidth - ScaleW(15) - ScaleW(65), 0, ScaleW(65), ScaleW(20)) textAlignment:NSTextAlignmentRight];
...
-(UILabel *)failReasonLabel
{
    if (nil == _failReasonLabel) {
        _failReasonLabel = [WLTools allocLabel:SSKJLocalized(@"", nil) font:systemThinFont(ScaleW(13.5)) textColor:kLineGrayColor frame:CGRectMake(self.failImageView.right + ScaleW(5),self.checkTimeTitleLabel.y, ScreenWidth  - self.failImageView.right- ScaleW(20), ScaleW(14)) textAlignment:NSTextAlignmentLeft];
...
-(void)setCellWithDealType:(DealType)dealType model:(HeBi_TiBiRecord_Index_Model *)model
{
    ...
    if (model.addtime) {
        self.submitTimeLabel.text = [WLTools convertTimestamp:model.addtime.doubleValue andFormat:@"yyyy-MM-dd HH:mm:ss"];
    }else{
        self.submitTimeLabel.text = @"----";
    }
    if (model.check_time) {
        self.checkTimeLabel.text = [WLTools convertTimestamp:model.check_time.doubleValue andFormat:@"yyyy-MM-dd HH:mm:ss"];
    }else{
    ...
    switch (status) {
        ...
        case 2:
        {
            ...
            self.cancleButton.hidden = YES;
            if (dealType == DealTypeTibi) {
                statusString = SSKJLocalized(@"提币成功", nil);
            }else{
                statusString = SSKJLocalized(@"充币成功", nil);
            }
        }
            break;
        case 3:
        {
            ...
            statusString = SSKJLocalized(@"审核失败", nil);
            color = RED_HEX_COLOR;
        }
            break;
        case 5:
