...
- (void)webSocket:(SRWebSocket *)webSocket didReceiveMessage:(id)message{
    ...
    [[NSNotificationCenter defaultCenter]postNotificationName:KSocketLongNofication object:[self didWithData:message]];
}
...
-(NSDictionary *)didWithData:(id)data
{
    ...
    NSString *goodsCode = [NSString stringTransformObject:[singleGoodsDatas objectForKey:@"code"]];
