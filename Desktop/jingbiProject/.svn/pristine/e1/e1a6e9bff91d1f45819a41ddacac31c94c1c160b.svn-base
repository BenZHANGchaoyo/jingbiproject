...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.dateLabel.text = [WLTools convertTimestamp:[dic[@"add_time"] doubleValue]/1000 andFormat:@"yyyy-MM-dd HH:mm"];
    ...
    cell.amountlabel.text = [NSString stringWithFormat:@"%@USDT",dic[@"total_num"]];
