...
-(UIButton *)cancleButton
{
    if (nil == _cancleButton) {
        ...
        [_cancleButton setTitleColor:kTextPinkWhiteColor forState:UIControlStateNormal];
...
{
    if (nil == _titleLabel) {
        _titleLabel = [WLTools allocLabel:@"" font:systemBoldFont(ScaleW(14)) textColor:kTextLightBlueColor frame:CGRectMake(0, 0, ScreenWidth, ScaleW(48)) textAlignment:NSTextAlignmentCenter];
