...
-(UILabel *)nameLabel
{
    if (nil == _nameLabel) {
        ...
        _nameLabel = [WLTools allocLabel:@"" font:systemFont(ScaleW(16)) textColor:kMainWihteColor frame:CGRectMake(ScaleW(15), ScaleW(15), width, ScaleW(30)) textAlignment:NSTextAlignmentLeft];
...
-(UILabel *)contactLabel
{
    if (nil == _contactLabel) {
        _contactLabel = [WLTools allocLabel:@"" font:systemFont(ScaleW(12)) textColor:kMainWihteColor frame:CGRectMake(self.nameLabel.right, 0, self.nameLabel.width, ScaleW(15)) textAlignment:NSTextAlignmentCenter];
...
{
    if (nil == _timeLabel) {
        _timeLabel = [WLTools allocLabel:@"" font:[UIFont systemFontOfSize:ScaleW(11)] textColor:kMainWihteColor frame:CGRectMake(self.contactLabel.right, self.nameLabel.bottom + ScaleW(13), self.nameLabel.width, ScaleW(13)) textAlignment:NSTextAlignmentRight];
